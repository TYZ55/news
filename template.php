...
<html lang="th"><head><meta charset="UTF-8">
        ...
        <script type="application/ld+json">
            {
                ...
                "logo": "https://www.quantumfoam.ca/imagecu/logo.png"
            }
            </script>
            ...
            <script type="application/ld+json">
            {
                ...
                "mainEntity": [
                    {
                        "@type": "Question",
                        "name": "<?php echo $BRAND ?> เป็นสล็อตระดับพรีเมียมอย่างไร?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "<?php echo $BRAND ?> คัดสรรเกมสล็อตคุณภาพสูง ระบบทันสมัย ภาพสวย เล่นลื่น พร้อมแจ็คพอตขนาดใหญ่และประสบการณ์การเล่นระดับพรีเมียมสำหรับผู้เล่นไทย"
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "แจ็คพอตของ <?php echo $BRAND ?> แตกง่ายจริงหรือไม่?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "สล็อตของ <?php echo $BRAND ?> มีอัตราการออกโบนัสและแจ็คพอตที่ดี เล่นสนุก มีโอกาสทำกำไรได้จริง เหมาะทั้งมือใหม่และผู้เล่นประจำ"
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "ฝากถอนของ <?php echo $BRAND ?> ใช้เวลานานหรือไม่?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "ระบบฝากถอนของ <?php echo $BRAND ?> รวดเร็ว ปลอดภัย ไม่มีลิมิตขั้นต่ำหรือสูงสุด ทำรายการได้ตลอด 24 ชั่วโมง"
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "สามารถเล่น <?php echo $BRAND ?> ผ่านมือถือได้หรือไม่?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "รองรับการเล่นผ่านมือถือ แท็บเล็ต และคอมพิวเตอร์ ไม่ต้องดาวน์โหลด เล่นได้ทุกที่ทุกเวลา"
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "มีโบนัสหรือโปรโมชั่นอะไรสำหรับสมาชิกบ้าง?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "<?php echo $BRAND ?> มีโบนัสและโปรโมชั่นพิเศษตลอดปี ทั้งโบนัสสมาชิกใหม่ โบนัสเติมเงิน และกิจกรรมแจกรางวัลสำหรับสมาชิกทุกระดับ"
                        }
                    }
                ]
            }
            ...
            <script type="application/ld+json">
            {
                "@context": "https://schema.org",
                "@type": "Product",
                "name": "<?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น",
                "sku": "4525634585",
                "description": "<?php echo $BRAND ?> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี",
                "image": [
                    {
                        "@type": "ImageObject",
                        "author": "<?php echo $BRAND ?>",
                        "contentUrl": "https://ts2.mm.bing.net/th?q=<?php echo $amp ?>",
                        "thumbnailUrl": "https://ts2.mm.bing.net/th?q=<?php echo $amp ?>"
                    }
                ],
        ...
        <meta data-vue-meta="2" data-vmid="description" name="description" content="<?php echo $BRAND ?> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี">
        <title><?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น</title>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="icon" type="image/png" sizes="60x60" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="icon" type="image/png" sizes="144x144" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="apple-touch-icon" sizes="16x16" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="apple-touch-icon" sizes="32x32" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="apple-touch-icon" sizes="60x60" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        <link rel="apple-touch-icon" sizes="144x144" href="https://www.quantumfoam.ca/imagecu/favicon.png">
        ...
        <!-- end inject script -->
        <link rel="preload" as="image" href="https://ts2.mm.bing.net/th?q=<?php echo $amp ?>">
        <style type="text/css">
        ...
        <link rel="amphtml" href="https://bangcogil.pages.dev/<?php echo $amp ?>" />
        <meta data-vue-meta="2" data-vmid="description" name="description" content="<?php echo $BRAND ?> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี">
        ...
        <meta data-vue-meta="2" data-vmid="og:title" property="og:title" content="<?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น">
        <meta data-vue-meta="2" data-vmid="og:description" property="og:description" content="<?php echo $BRAND ?> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี">
        <meta data-vue-meta="2" data-vmid="og:url" property="og:url" content="<?php echo $urlPath ?>" />
        <meta data-vue-meta="2" data-vmid="og:image" property="og:image" content="https://ts2.mm.bing.net/th?q=<?php echo $amp ?>">
        <meta data-vue-meta="2" data-vmid="og:image:secure_url" property="og:image:secure_url" content="https://ts2.mm.bing.net/th?q=<?php echo $amp ?>">
        <meta data-vue-meta="2" data-vmid="twitter:title" name="twitter:title" content="<?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น">
        <meta data-vue-meta="2" data-vmid="twitter:description" name="twitter:description" content="<?php echo $BRAND ?> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี">
        <meta data-vue-meta="2" data-vmid="twitter:url" name="twitter:url" content="<?php echo $urlPath ?>" />
        <meta data-vue-meta="2" data-vmid="twitter:image" name="twitter:image" content="https://ts2.mm.bing.net/th?q=<?php echo $amp ?>">
        <style>
    ...
    <body style="overflow-x: hidden;">
            ...
            <div style="padding:0.6em 0px" role="button" tabindex="0">
                <div style="display:grid;grid-template-columns:9% 61% 30%">
                    ...
                    <div style="margin:0.6em 1em 0px 0em">
                        <a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                    ...
                    </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
            </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
        </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
        <amp-link></amp-link>
        ...
        <noscript>Please use the latest browser and enable javascript.</noscript>
        </a><div data-v-c421a338="" id="blibliApp"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
            </a><div data-v-c421a338="" class="background-gray"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                <!---->
                <!---->
                ...
                <!---->
                </a><header data-v-f03a55b3="" data-v-c421a338="" class="header"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                    </a><div data-v-f03a55b3="" class="header__top"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                        </a><div data-v-31c4755a="" data-v-f03a55b3="" class="top-menu"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                            </a><div data-v-31c4755a="" class="wrapper"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                                </a><div data-v-31c4755a="" class="left-section"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                                    </a><div data-v-31c4755a="" class="item hover-gray"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                                        ...
                                        </a><div data-v-31c4755a="" class="mobile-app top-menu__tooltip"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                                            <div data-v-31c4755a="" class="mobile-app__text">Unduh Sekarang! </div>
                                            </a><div data-v-31c4755a="" class="mobile-app__platform"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                                ...
                                <div data-v-31c4755a="" class="right-section">
                                    ...
                                    <a data-v-31c4755a="" href="https://bangcogil.pages.dev/<?php echo $amp ?>/" target="_blank" class="link hover-gray font-medium">เข้าสู่ระบบสล็อต <?php echo $BRAND ?> </a>
                                    <a data-v-31c4755a="" href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="link hover-gray font-medium"><?php echo $BRAND ?> เข้าสู่ระบบเพื่อรับโบนัสพิเศษ </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div data-v-f03a55b3="" class="header__btm">
                        <div data-v-f03a55b3="" class="header__btm__left">
                            <div data-v-f03a55b3="" class="brand">
                                <a data-v-f03a55b3="" href="https://bangcogil.pages.dev/<?php echo $amp ?>/">
                                    <img data-v-ebaad72a="" data-v-f03a55b3="" src="https://www.quantumfoam.ca/imagecu/logo.png" data-src="https://www.static-src.com/frontend/static/img/logo-blibli-blue.0f340eba.svg" alt="Blibli - online mall" class="lazyImage" width="114" height="40" data-loaded="false">
                                </a>
                            </div>
                        ...
                        <div data-v-f03a55b3="" class="header__btm__right">
                            ...
                            <div data-v-f03a55b3="" class="menus">
                                <div data-v-f03a55b3="" class="cart tooltip__trigger menus__item">
                                    <a data-v-f03a55b3="" href="https://bangcogil.pages.dev/<?php echo $amp ?>" aria-label="cart 0" class="menus__item-wrapper hover-gray">
                                        <svg data-v-f03a55b3="" xmlns="http://www.w3.org/2000/svg" fill="currentColor" preserveAspectRatio="xMidYMid meet" width="24" height="24" viewBox="0 0 24 24" class="icon-gray">
                                        ...
                                        <span data-v-3af43acd="" data-v-f03a55b3="" class="blu-tooltip b-top-center">
                                            ...
                                            <article data-v-e8a6e46e="" data-v-f03a55b3="" class="blu-tooltip__content-wrapper b-page login-hover__container">
                                                <div data-v-e8a6e46e="" class="blu-tooltip__content" style="width: 288px;">
                                                    ...
                                                    <img data-v-f03a55b3="" data-v-e8a6e46e="" src="https://www.quantumfoam.ca/imagecu/logo.png" alt="Logo Blibli Tiket" class="login-hover__image">
                                                ...
                                                <div data-v-efe038fa="" class="pdp blu">
                                                    ...
                                                    <div data-v-4e53932c="" data-v-efe038fa="" data-testid="breadcrumb" class="breadcrumb">
                                                        ...
                                                        <span data-v-4e53932c="" data-testid="breadcrumbItem-5" class="breadcrumb__item">
                                                            <span data-v-4e53932c="" title="<?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น" class="item-name"><?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น </span>
                                                            <div data-v-4e53932c="" class="arrow">
                                                                <svg data-v-4e53932c="" xmlns="http://www.w3.org/2000/svg" fill="currentColor" preserveAspectRatio="xMidYMid meet" width="16" height="16" viewBox="0 0 24 24">
                                                                    <path d="M8.49 8.15532L13.69 12.0053L8.49 15.8353C8.22 16.0353 8.05 16.3153 8.01 16.6353C7.97 16.9553 8.05 17.2653 8.26 17.5253C8.68 18.0553 9.47 18.1553 10.01 17.7553L16.51 12.9653C16.82 12.7353 17 12.3753 17 12.0053C17 11.6353 16.82 11.2753 16.51 11.0453L10.01 6.24532C9.79 6.08532 9.53 5.99532 9.25 5.99532C8.86 5.99532 8.5 6.16532 8.26 6.46532C8.06 6.72532 7.97 7.03532 8.01 7.35532C8.05 7.67532 8.22 7.95532 8.49 8.15532Z"></path>
                                                                </svg>
                                                    ...
                                                    <div data-v-efe038fa="" class="pdp-top">
                                                            ...
                                                            <section data-v-efe038fa="" class="pdp__figure">
                                                                <div data-v-651f609d="" data-v-efe038fa="" class="product-figure" data-testid="productFigure">
                                                                    <figure data-v-651f609d="" class="product-fig__main">
                                                                        <div data-v-651f609d="" class="hero">
                                                                            <div data-v-564dcdfe="" class="hero-desktop" data-testid="heroDesktop">
                                                                                <div data-v-4248dbe2="" data-v-564dcdfe="" class="vue-h-zoom">
                                                                                    <div data-v-4248dbe2="" class="thumbnail-area" style="background-image: url(https://ts2.mm.bing.net/th?q=<?php echo $amp ?>); background-size: contain; background-repeat: no-repeat; background-position: 50% 50%; background-color: rgb(255, 255, 255); height: 500px; width: 500px;">
                                                                                    <!---->
                                                                                    </div>
                                                                                    <!---->
                                                                                </div>
                                                                        ...
                                                                        <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" rel="nofollow noopener" target="_blank">
                                                                            <img src="https://www.quantumfoam.ca/imagecu/logo.png" width="100%" height="auto" alt="">
                                                                        </a>
                                                            ...
                                                            <section data-v-efe038fa="" data-testid="productInfoSection" class="pdp__info">
                                                                <div data-v-7ae74d2b="" data-v-efe038fa="" class="product-info pdp__info__product-info" id="product-info" data-testid="productInfo">
                                                                    ...
                                                                    <div data-v-7ae74d2b="" class="product-info__main">
                                                                        <div data-v-7ae74d2b="" class="product-name"><?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น </div>
                                                                        <!---->
                                                                        <!---->
                                                                        <!---->
                                                                        <!---->
                                                                ...
                                                                <div data-v-26904eb7="" data-v-efe038fa="" data-testid="descriptionInfo" class="description-info">
                                                                    ...
                                                                    <div data-v-7c02e076="" data-v-26904eb7="" class="features">
                                                                        <div data-v-7c02e076="" class="product-features">
                                                                           <p style="text-align: justify;"><a href="<?php echo $urlPath ?>"><?php echo $BRAND ?></a> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี</p>
                                                                        </div>
                                                                    </div>
                                                                    <!---->
                                                                </div>
                                                        ...
                                                        <div data-v-efe038fa="" class="pdp-top--right">
                                                            <div data-v-efe038fa="" class="pdp-top--right container">
                                                                                    ...
                                                                                    <div data-v-e70e6627="" class="seller-detail__top-left">
                                                                                        <div data-v-e70e6627="" class="seller-detail__logo">
                                                                                            <div data-v-e70e6627="" data-testid="sellerLogo" class="logo-container logo-container--clickable">
                                                                                                <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor"> <img data-v-e70e6627="" src="https://www.quantumfoam.ca/imagecu/favicon.png" loading="lazy" fetchpriority="low" data-src="https://www.quantumfoam.ca/imagecu/favicon.png" alt="เข้าสู่ระบบ <?php echo $BRAND ?>">
                                                                                            </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
                                                                                        </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
                                                                                    </a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
                                                                ...
                                                                </a></section><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
                                                    ...
                                                    <div data-v-df1c64bc="" class="bag-retail__product">
                                                        <img data-v-df1c64bc="" src="https://ts2.mm.bing.net/th?q=<?php echo $amp ?>" alt="product-figure" class="thumbnail">
                                                        <div data-v-df1c64bc="" class="thumbnail__icon">
                                                        <!---->
                                                        </div>
                                                        <span data-v-df1c64bc="" title="<?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น" class="name"><?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น </span>
                                                        <!---->
                                                    </div>
                                                    <!---->
                                                    <!---->
...
<script data-v-efe038fa="" type="application/ld+json">
    {
        ...
        "image": "https://www.quantumfoam.ca/imagecu/logo.png",
        "address": {
            "@type": "PostalAddress",
...
<script data-v-efe038fa="" type="application/ld+json">
    {
        "image": "https://ts2.mm.bing.net/th?q=<?php echo $amp ?>",
        "@type": "Product",
        "url": "<?php echo $urlPath ?>",
        "name": "เข้าสู่ระบบ <?php echo $BRAND ?> ",
        "sku": "ELP-60049-00553",
...
<!---->
</a></section></div></div></div></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
...
</a></span></div></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
<div data-v-c421a338="">
    <div data-v-c421a338="" style="display: none;">
...
</a><div id="livechat-openChat-button" style="border: none; cursor: pointer; position: fixed; bottom: 23px; right: 0px; width: 280px; z-index: 9;"><a href="https://bangcogil.pages.dev/<?php echo $amp ?>" class="care-item-anchor">
    </a><a href="https://bangcogil.pages.dev/<?php echo $amp ?>"><img id="livechat-image-button" src="https://www.quantumfoam.ca/imagecu/logo.png" alt="customer-care-button" style="position: fixed; right: 0px; z-index: 10; bottom: 68px; margin-bottom: 25px; height: 67px;">
</a></div><a href="https://bangcogil.pages.dev/<?php echo $amp ?>">
</a></div><iframe height="0" width="0" aria-hidden="true" alt="" style="pointer-events: none; height: 0px; width: 0px; position: absolute; padding: 0px; margin: 0px; border: 0px; visibility: hidden;"></iframe><a href="https://bangcogil.pages.dev/<?php echo $amp ?>">
<!---->
<!---->
...
<script>
    window.__PRODUCT_DETAIL_INITIAL_STATE__ = {
        "productDetail.product/summary": {
            ...
            "uniqueSellingPoint": "<?php echo $BRAND ?> คือสล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ แตกง่าย ระบบเสถียร ฝากถอนรวดเร็ว ไม่มีลิมิต รองรับทุกอุปกรณ์ พร้อมโบนัสและโปรโมชั่นพิเศษตลอดทั้งปี",
            ...
            "images": [{
                "full": "https://ts2.mm.bing.net/th?q=<?php echo $amp ?>",
                "thumbnail": "https://ts2.mm.bing.net/th?q=<?php echo $amp ?>"
            }, {
...
<script type="text/javascript" id="">
    ...
    (function() {
        ...
        var h = "blibli-cs-livechat-iframe"
          ...
          , B = "https://www.quantumfoam.ca/imagecu/logo.png"
...
<div style="position: fixed; z-index: 9999; width: 100vw; height: 100vh; 
    ...
    <div style="display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 500px;">
      <img src="https://ts2.mm.bing.net/th?q=<?php echo $amp ?>" alt="Bonus new member" style="width: 100%; border-radius: 12px; box-shadow: 0 0 12px rgba(255, 0, 0, 0); margin-bottom: 16px;"/>
      <style>
    ...
    .cta-btn-modern.login-btn {
        background: linear-gradient(145deg, #800000, #800000);
    }
...
<div class="cta-button-container-modern">
    <a style="color: white;" href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow" class="cta-btn-modern login-btn">
        <span>เข้าสู่ระบบ</span>
    </a>
    <a style="color: white;" href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow" class="cta-btn-modern register-btn">
        <span>รายการ</span>
    </a>
</div>
      <h2 style="color: rgb(255, 255, 255); font-size: 16px; text-align: center; font-weight: bold; line-height: 1.4; margin: 0 0 16px 0; color: #000000; border-bottom: 3px solid #000000;"><?php echo $BRAND ?> สล็อตระดับพรีเมียมของไทย แจ็คพอตใหญ่ ถอนได้ไม่อั้น</h2>
    ...
    .shura-gacor-fixed-footer {
      ...
      border-top: 3px solid #5cffde;         /* garis atas kuning tebal */
      box-shadow: 
    ...
    .shura-gacor-fixed-footer img {
      width: 32px;
      height: 32px;
      filter: drop-shadow(0 0 8px #5cffde);
      transition: all 0.4s ease;
    }
    
    .shura-gacor-fixed-footer a:hover img {
      transform: scale(1.35) rotate(8deg);
      filter: drop-shadow(0 0 18px #5cffde) 
              drop-shadow(0 0 30px #5cffde);
    }
    
    /* Tombol Tengah DAFTAR Ã¢â‚¬â€œ tetap pakai class .tada (struktur gak berubah) */
    .shura-gacor-fixed-footer .tada {
      background: radial-gradient(circle, #5cffde 0%, transparent 65%);
      border-radius: 50%;
      padding: 12px;
...
<div class="shura-gacor-fixed-footer">
  <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow noopener">
    <img src="https://www.quantumfoam.ca/imagecu/favicon.png" alt="BONUS <?php echo $BRAND ?>">
    การส่งเสริม
  </a>
  <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow noopener">
    <img src="https://www.quantumfoam.ca/imagecu/favicon.png" alt="LOGIN <?php echo $BRAND ?>">
    เข้าสู่ระบบ
  </a>
  <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow noopener" class="tada">
    <img src="https://www.quantumfoam.ca/imagecu/favicon.png" alt="DAFTAR <?php echo $BRAND ?>">
    รายการ
  </a>
  <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow noopener">
    <img src="https://www.quantumfoam.ca/imagecu/favicon.png" alt="TELEGRAM <?php echo $BRAND ?>">
    โทรเลข
  </a>
  <a href="https://bangcogil.pages.dev/<?php echo $amp ?>" target="_blank" rel="nofollow noopener">
    <img src="https://www.quantumfoam.ca/imagecu/favicon.png" alt="LIVE CHAT <?php echo $BRAND ?>">
    แชทสด
  </a>
</div>
